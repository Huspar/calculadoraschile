        ...
        <div class="max-w-[1200px] mx-auto px-6">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-4">
                    <button id="mobile-menu-btn" aria-label="Abrir menú de navegación" onclick="var m=document.getElementById('mobile-menu');if(m)m.classList.toggle('hidden')" class="md:hidden p-2 rounded-lg text-slate-500 hover:bg-slate-100 transition-colors active:scale-95 duration-100">
